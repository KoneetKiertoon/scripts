#!/bin/bash
#
# With much fanfare and hype I hereby present to you:
#
#   /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/
#  /~~=~~ World's Slowest JSON Parser ~~=~~/
# /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/
#
# This file is an utterly useless exercise in bash wizardry. I removed
# this from hardware-inspect.sh after it became painfully obvious that
